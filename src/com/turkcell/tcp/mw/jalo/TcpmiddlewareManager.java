 ...
 */
package com.turkcell.tcp.mw.jalo;
...
/**
 * This is the extension manager of the Tcpmiddleware extension.
 */
public class TcpmiddlewareManager extends GeneratedTcpmiddlewareManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(TcpmiddlewareManager.class);
	 ...
	 */
	public static TcpmiddlewareManager getInstance()
	{
		return (TcpmiddlewareManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(TcpmiddlewareConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public TcpmiddlewareManager() // NOPMD 
	{
		LOG.debug("constructor of TcpmiddlewareManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of TcpmiddlewareManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of TcpmiddlewareManager called, current tenant: {}", getTenant().getTenantID());
	}
